...
def all_vowel_pairs(words)
    ...
    words.each_with_index do |word1, index1|
        words.each_with_index do |word2, index2|
           pair = word1 + " " + word2
           vowel_pairs << pair if index2 > index1 && vowels.all? {|vowel| pair.include?(vowel)}
        end
    end
    vowel_pairs
end
...
def find_bigrams(str, bigrams)
    ...
    #       bigram_array << bigram if word.include?(bigram)
    #     end
    # end
    # bigram_array
...
class String
    ...
    def substrings(length = nil)
        ...
        if length.nil?
            ...
            subs.select { |substring| substring.length == length}
        end
    end
    ...
    def caesar_cipher(num)
        ...
        self.each_char do |letter|
            ...
            new_letter = alpha[(old_index + num) % 26]
            new_str += new_letter
        end
        new_str
    end
