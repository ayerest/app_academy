...
def gcd_of_last_digits(int_one, int_two)
   intone_digit = last_digit(int_one)
   inttwo_digit = last_digit(int_two)
   return intone_digit.gcd(inttwo_digit)
end
...
def dec_remainder_of_two_integers(i_dividend, i_divisor)
  one_dividend = i_dividend.to_f
  two_divisor = i_divisor.to_f
  return dec_remainder_of_two_floats(one_dividend, two_divisor)
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
  decimal = dec_remainder_of_two_integers(i_dividend, i_divisor)
  remainder = decimal * i_divisor
